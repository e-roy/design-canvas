...
const MAIN_CANVAS_ID = "main-collaborative-canvas-refactored";

export default function CanvasRefactoredPage() {
  const canvasRef = useRef<CanvasRefactoredRef>(null);
